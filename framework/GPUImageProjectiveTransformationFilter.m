//
//  GPUImageProjectiveTransformationFilter.m
//  GPUImage
//
...
#import "GPUImageProjectiveTransformationFilter.h"

NSString *const kGPUImageProjectiveTransformationFragmentShaderString = SHADER_STRING
(
 ...
 void main()
 {
     ...
     */
     ...
     // zuvor
     highp vec3 textureCoordinateTransformedH = trafoMatrix * textureCoordinateH;  // TODO: b^T*A^T vs. A*b
     gl_FragColor = texture2D(inputImageTexture, textureCoordinateTransformedH.xy/textureCoordinateTransformedH.z);
...
@implementation GPUImageProjectiveTransformationFilter
...
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kGPUImageProjectiveTransformationFragmentShaderString]))
    {
        return nil;
    }
